...
If we have scripts of sql that is used frequently, then we can create stored procedure

Stored Procedure can be found under Progammability and can be exected by just calling it with exec function, 
